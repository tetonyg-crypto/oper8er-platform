...
const PRICING = [
  {
    ...
    features: [
      'Full Command access for 90 days',
      'White-glove installation on every rep',
      'Founder-led onboarding workshop',
      '1,500 Message Guarantee (or full refund)',
      '$6,000 in bonuses included',
      'Converts to $1,999/mo founding rate',
    ],
    cta: 'Claim Your Founding Slot',
    tier: 'founding_pilot',
    highlighted: false,
  },
  {
    name: 'Command',
    price: '$2,999',
    period: '/mo or $29,990/year',
    features: [
      '6 channels: CRM, Gmail, LinkedIn, FB, Messenger, IG',
      'Voice-first input — dictate from the lot',
      'Custom dealership voice training',
      'Real-time GM dashboard + rep leaderboard',
      'Ghost lead recovery + objection coaching',
      'Owner ROI dashboard',
    ],
    cta: 'Book a Demo',
    tier: 'command',
